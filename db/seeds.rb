...
event1 = Event.create(client_id: amy.id, event_name: "Amy & Nugget", location_name: "Caboose Commons" ,location_address: "2918 Eskridge Rd, Fairfax, VA 22031" , date: "2020-11-11", time: "25:30", status: "complete", admin_id: 1)
...
event3 = Event.create(client_id: giulia.id, event_name: "Giulia's Linkedin Portraits", location_name: "Tatte Bakery & Cafe", location_address: "1200 New Hampshire Ave NW, Washington, DC 20036", date: "2020-01-11", time: "13:00", status: "consultation",admin_id: 1)
event4 = Event.create(client_id: giulia.id, event_name: "Giulia's Family Session", location_name: "U.S. National Arboretum", location_address: "3501 New York Ave NE Washington, DC 20002", date: "2020-12-11", time: "10:00", status: "consultation",admin_id: 1)
event5 = Event.create(client_id: melinda.id, event_name: "Melinda's Linkedin Portraits", location_name: "Burke Lake Park" , location_address: "7315 Ox Rd, Fairfax Station, VA 22039", date: "2020-06-03" , time: "21:00", status: "editing" , admin_id: 1)
event6 = Event.create(client_id: jina.id, event_name: "Jina's Anniversary Session", location_name: "Dumbarton Oaks", location_address: "3120 R St NW, Washington, DC 20007", date: "2020-12-09" , time: "24:00", status: "editing" , admin_id: 1)
event7 = Event.create(client_id: kalada.id, event_name: "Kalada's Album Cover Session", location_name: "The Yards Park", location_address: "355 Water St SE, Washington, DC 20003" , date: "2020-09-03" , time: "18:00" , status: "editing", admin_id: 1)
...
event9 = Event.create(client_id: mark.id, event_name: "Mark's Linkedin Portraits", location_name: "Meridian Hill Park" , location_address: "16th St NW &, W St NW, Washington, DC 20009" , date: "2020-12-13" , time: "23:30" , status: "complete" , admin_id: 1)
event10 = Event.create(client_id: shannon.id, event_name: "Shannon's Family Sesh 2020", location_name: "Union Market" , location_address: "1309 5th St NE, Washington, DC 20002", date: "2020-12-01" , time: "20:30" , status: "consultation" , admin_id: 1)
